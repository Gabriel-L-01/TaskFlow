...
import { Trash2, Plus, GripVertical, Edit, CheckSquare, RotateCcw, ClipboardList, Lock } from 'lucide-react';
...
function PresetTaskItem({ task, isEditing, onUpdate, onDelete }: PresetTaskItemProps) {
    ...
    >
      ...
      {isEditingName ? (
        ...
        />
         ...
         <span 
            className={cn('flex-1 cursor-default py-0.5 text-base', task.done && 'text-muted-foreground')}
